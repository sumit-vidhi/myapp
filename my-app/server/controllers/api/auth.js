...
module.exports = {
	...
	register: function(req, res, next){	
		...
		if(model.load(req.body) && model.validate() && (req.body.action=="register")){
			...
			.then(function(rows) {//If exist return error;
		      	if(rows.recordset.length > 0) throw new Error('email_already_used');
