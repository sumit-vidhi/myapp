...
module.exports = {
	insert : function(table, keys,data, cb){
		let query = "INSERT INTO "+table+ "("+keys+") OUTPUT Inserted.ID values('"+data+"')";
//let params = [table,keys, data]; 
...
function runQuery(query, cb){
	...
	//	console.log(query);
		return core.connect().query(query, cb);	
