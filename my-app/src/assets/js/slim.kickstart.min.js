                ...
                var u = function() {
                    ...
                    l = function() {
                        ...
                        function i(t, e, i, r, s, h) {
                            var u, l, p, c, d, f, _, m, g, v, y, w, b, k, x, S, E, C, P, R, T, M, I, L, O = t.data,
                                z = h + h + 1,
                                D = r - 1,
                                A = s - 1,
                                H = h + 1,
                            ...
                            var j = o[h],
                                V = a[h];
                            for (l = 0; l < s; l++) {
                                for (S = E = C = P = m = g = v = y = 0, w = H * (R = O[f]), b = H * (T = O[f + 1]), k = H * (M = O[f + 2]), x = H * (I = O[f + 3]), m += U * R, g += U * T, v += U * M, y += U * I, N = B, p = 0; p < H; p++) N.r = R, N.g = T, N.b = M, N.a = I, N = N.next;
                                for (p = 1; p < H; p++) c = f + ((D < p ? D : p) << 2), m += (N.r = R = O[c]) * (L = H - p), g += (N.g = T = O[c + 1]) * L, v += (N.b = M = O[c + 2]) * L, y += (N.a = I = O[c + 3]) * L, S += R, E += T, C += M, P += I, N = N.next;
                                for (W = B, q = F, u = 0; u < r; u++) O[f + 3] = I = y * j >> V, 0 != I ? (I = 255 / I, O[f] = (m * j >> V) * I, O[f + 1] = (g * j >> V) * I, O[f + 2] = (v * j >> V) * I) : O[f] = O[f + 1] = O[f + 2] = 0, m -= w, g -= b, v -= k, y -= x, w -= W.r, b -= W.g, k -= W.b, x -= W.a, c = _ + ((c = u + h + 1) < D ? c : D) << 2, S += W.r = O[c], E += W.g = O[c + 1], C += W.b = O[c + 2], P += W.a = O[c + 3], m += S, g += E, v += C, y += P, W = W.next, w += R = q.r, b += T = q.g, k += M = q.b, x += I = q.a, S -= R, E -= T, C -= M, P -= I, q = q.next, f += 4;
                                _ += r
                            }
                            for (u = 0; u < r; u++) {
                                for (E = C = P = S = g = v = y = m = 0, f = u << 2, w = H * (R = O[f]), b = H * (T = O[f + 1]), k = H * (M = O[f + 2]), x = H * (I = O[f + 3]), m += U * R, g += U * T, v += U * M, y += U * I, N = B, p = 0; p < H; p++) N.r = R, N.g = T, N.b = M, N.a = I, N = N.next;
                                for (d = r, p = 1; p <= h; p++) f = d + u << 2, m += (N.r = R = O[f]) * (L = H - p), g += (N.g = T = O[f + 1]) * L, v += (N.b = M = O[f + 2]) * L, y += (N.a = I = O[f + 3]) * L, S += R, E += T, C += M, P += I, N = N.next, p < A && (d += r);
                                for (f = u, W = B, q = F, l = 0; l < s; l++) c = f << 2, O[c + 3] = I = y * j >> V, I > 0 ? (I = 255 / I, O[c] = (m * j >> V) * I, O[c + 1] = (g * j >> V) * I, O[c + 2] = (v * j >> V) * I) : O[c] = O[c + 1] = O[c + 2] = 0, m -= w, g -= b, v -= k, y -= x, w -= W.r, b -= W.g, k -= W.b, x -= W.a, c = u + ((c = l + H) < A ? c : A) * r << 2, m += S += W.r = O[c], g += E += W.g = O[c + 1], v += C += W.b = O[c + 2], y += P += W.a = O[c + 3], W = W.next, w += R = q.r, b += T = q.g, k += M = q.b, x += I = q.a, S -= R, E -= T, C -= M, P -= I, q = q.next, f += r
                            }
                            return t
                        }
                ...
                var p = function() {
                    ...
                    Mt = function() {
                        var i = {
                            n: function(t, e, i, n) {
                                var o, a, r, s, h, u, l, p;
                                return r = t.y + t.height, o = I(e.y, 0, r), r - o < i.min.height && (o = r - i.min.height), h = n ? (r - o) / n : t.width, h < i.min.width && (h = i.min.width, o = r - h * n), l = .5 * (h - t.width), s = t.x - l, a = t.x + t.width + l, (s < 0 || a > i.width) && (p = Math.min(t.x, i.width - (t.x + t.width)), s = t.x - p, a = t.x + t.width + p, h = a - s, u = h * n, o = r - u), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                            ...
                            s: function(t, e, i, n) {
                                var o, a, r, s, h, u, l, p;
                                return o = t.y, r = I(e.y, o, i.height), r - o < i.min.height && (r = o + i.min.height), h = n ? (r - o) / n : t.width, h < i.min.width && (h = i.min.width, r = o + h * n), l = .5 * (h - t.width), s = t.x - l, a = t.x + t.width + l, (s < 0 || a > i.width) && (p = Math.min(t.x, i.width - (t.x + t.width)), s = t.x - p, a = t.x + t.width + p, h = a - s, u = h * n, r = o + u), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                            ...
                            e: function(t, e, i, n) {
                                var o, a, r, s, h, u, l, p;
                                return s = t.x, a = I(e.x, s, i.width), a - s < i.min.width && (a = s + i.min.width), u = n ? (a - s) * n : t.height, u < i.min.height && (u = i.min.height, a = s + u / n), l = .5 * (u - t.height), o = t.y - l, r = t.y + t.height + l, (o < 0 || r > i.height) && (p = Math.min(t.y, i.height - (t.y + t.height)), o = t.y - p, r = t.y + t.height + p, u = r - o, h = u / n, a = s + h), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                            ...
                            w: function n(t, e, i, o) {
                                var a, r, s, h, n, u, l, p;
                                return r = t.x + t.width, h = I(e.x, 0, r), r - h < i.min.width && (h = r - i.min.width), u = o ? (r - h) * o : t.height, u < i.min.height && (u = i.min.height, h = r - u / o), l = .5 * (u - t.height), a = t.y - l, s = t.y + t.height + l, (a < 0 || s > i.height) && (p = Math.min(t.y, i.height - (t.y + t.height)), a = t.y - p, s = t.y + t.height + p, u = s - a, n = u / o, h = r - n), {
                                    x: h,
                                    y: a,
                                    width: r - h,
                                    height: s - a
                    ...
                    Gt = function() {
                        ...
                        return p(i, [{
                            ...
                            value: function() {
                                ...
                                var h = '\n\t\t<div class="slim-result">\n\t\t\t<img id="in" class="in" style="opacity:0" ' + (r ? 'src="' + r + '"' : "") + '><img><img style="opacity:0">\n\t\t</div>';
                ...
                return function() {
                    ...
                    Nt.concat(It.Buttons).concat("rotate").forEach(function(t) {
                        ...
                        for (var n in e) {
                            var o = f[n],
                                a = e[n];
                            o ? (a = o(a), a = null === a ? mt(Gt.options()[n]) : a, i[n] = a) : 0 === n.indexOf("meta") && (i.meta[R(n.substr(4))] = a)
                        }
                        return i
                    }, Gt.find = function(t) {
